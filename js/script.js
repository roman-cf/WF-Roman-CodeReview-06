...
var blogLocation4 = new myEvent("eve4", "Silvesterparty", "Vienna", 1120, "Wurmbstrasse 36", "Silvester-Feuerwerk-in-Wien-iStock-900581042.jpg", "Dec 31, 2019 23:59:59", 50);
...
var locationArray = [];
for (var i = 1; i < 9; i++) {
    locationArray.push(window["blogLocation" + i]);
}
